...
for t = 1:dataSetOpts.dataSet.nTasks
    ...
    groupTable = sortrows(groupTable);

if strcmp(currTask,'SAP')
    SAP_HRTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
    ...
    SAP_AmplitudeTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
...
elseif strcmp(currTask,'SAPC')
    SAPC_HRTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
        HR_PEtrials_mean, HR_PEtrials_min, HR_PEtrials_max, HR_posPEtrials_mean, HR_posPEtrials_min, HR_posPEtrials_max, ...
    ...
    SAPC_AmplitudeTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
        amp_PEtrials_mean, amp_PEtrials_min, amp_PEtrials_max,amp_posPEtrials_mean, amp_posPEtrials_min, amp_posPEtrials_max, ...
...
elseif strcmp(currTask,'AAA')
    AAA_HRTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
        HR_PEtrials_mean, HR_PEtrials_min, HR_PEtrials_max,HR_posPEtrials_mean, HR_posPEtrials_min, HR_posPEtrials_max, ...
    ...
    AAA_AmplitudeTable = table(dataSetOpts.dataSet.PIDs,groupTable.group,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
        amp_PEtrials_mean, amp_PEtrials_min, amp_PEtrials_max,amp_posPEtrials_mean, amp_posPEtrials_min, amp_posPEtrials_max, ...

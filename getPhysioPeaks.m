...
for t = 1:dataSetOpts.dataSet.nTasks
        ...
        if dataSetOpts.dataSet.participant(n).task(t).neuroComplete==1 || dataSetOpts.dataSet.participant(n).task(t).physioComplete==1
            ...
            if ~isempty(behavIDs)
                ...
                if ~isempty(f)
                    ...
                    BL_IBI(n,:) = mean(bl_peakIds(2:end)-bl_peakIds(1:end-1));
    ...
    if strcmp(currTask,'SAP')
        ...
        SAP_IBITable = table(dataSetOpts.dataSet.PIDs,group,BL_IBI,IBI1_StimSmiletrials,IBI2_StimSmiletrials,IBI3_StimSmiletrials,...
            ...
            'VariableNames',...
            {'ID','group','baseline IBI','pre stimSmile IBI1','pre stimSmile IBI2','stimSmile IBI3','stimSmile  IBI4', ...
    ...
    elseif strcmp(currTask,'SAPC')
        ...
        SAPC_IBITable = table(dataSetOpts.dataSet.PIDs,group,BL_IBI,IBI1_StimGoodtrials,IBI2_StimGoodtrials,IBI3_StimGoodtrials,...
            ...
            IBI1_negPEtrials,IBI2_negPEtrials,IBI3_negPEtrials,IBI4_negPEtrials,IBI5_negPEtrials,IBI6_negPEtrials,IBI7_negPEtrials,...
            'VariableNames',...
            {'ID','group','baseline IBI','pre stimGood IBI1','pre stimGood IBI2','stimGood IBI3','stimGood  IBI4', ...
    ...
    elseif strcmp(currTask,'AAA')
        ...
        AAA_IBITable = table(dataSetOpts.dataSet.PIDs,group,BL_IBI,IBI1_negOutcomes,IBI2_negOutcomes,IBI3_negOutcomes,IBI4_negOutcomes,...
            ...
            {'ID','group','baseline IBI','pre negOutcome IBI1','pre negOutcome IBI2','negOutcome IBI3','negOutcome IBI4', ...

...
for t = 1:data.dataSet.nTasks
        ...
        if ~isempty(behavIDs)
            ...
            if ~isempty(f)
                ...
                for iTime = 1:numel(dataFile.events.outcome_startTime)
                    ...
                    if isempty(ids)
                        dataFile.events.outcome_startTime(iTime) = datetime(dataFile.events.iti_startTime(iTime))-milliseconds(options.dur.showOutcome+options.dur.ITI(iTime));
    ...
    if strcmp(currTask,'SAP')
        SAP_HRTable = table(data.dataSet.PIDs,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
            ...
            {'ID','HR_baseline','meanHR_all','minHR_all','maxHR_all','meanHR_PE','minHR_PE','maxHR_PE', ...
        ...
        SAP_AmplitudeTable = table(data.dataSet.PIDs,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
            ...
            {'ID','amplitude_baseline','meanAmp_all','minAmp_all','maxAmp_all','meanAmp_PE','minAmp_PE','maxHR_PE',...
    ...
    elseif strcmp(currTask,'SAPC')
        SAPC_HRTable = table(data.dataSet.PIDs,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
            HR_PEtrials_mean, HR_PEtrials_min, HR_PEtrials_max, HR_posPEtrials_mean, HR_posPEtrials_min, HR_posPEtrials_max, ...
        ...
        SAPC_AmplitudeTable = table(data.dataSet.PIDs,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
            amp_PEtrials_mean, amp_PEtrials_min, amp_PEtrials_max,amp_posPEtrials_mean, amp_posPEtrials_min, amp_posPEtrials_max, ...
            ...
            {'ID','amplitude_baseline','meanAmp_all','minAmp_all','maxAmp_all','meanAmp_PE','minAmp_PE','maxAmp_PE', ...
            'meanAmp_posPE','minAmp_posPE','maxAmp_posPE','meanAmp_negPE','minAmp_negPE','maxAmp_negPE',...
    ...
    elseif strcmp(currTask,'AAA')
        AAA_HRTable = table(data.dataSet.PIDs,BL_HR,HR_allTrials_mean,HR_allTrials_min,HR_allTrials_max,...
            HR_PEtrials_mean, HR_PEtrials_min, HR_PEtrials_max,HR_posPEtrials_mean, HR_posPEtrials_min, HR_posPEtrials_max, ...
            HR_negPEtrials_mean, HR_negPEtrials_min, HR_negPEtrials_max,HR_partApproachtrials_mean,HR_partApproachtrials_min,...
            HR_partApproachtrials_max,'VariableNames',{'ID','HR_baseline','meanHR_all','minHR_all','maxHR_all', ...
            'meanHR_posPE','minHR_posPE','maxHR_posPE','meanHR_negPE','minHR_negPE','maxHR_negPE', ...
        ...
        AAA_AmplitudeTable = table(data.dataSet.PIDs,BL_amp,amp_allTrials_mean,amp_allTrials_min,amp_allTrials_max,...
            amp_PEtrials_mean, amp_PEtrials_min, amp_PEtrials_max,amp_posPEtrials_mean, amp_posPEtrials_min, amp_posPEtrials_max, ...
